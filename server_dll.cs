...
namespace CS2Dumper.Schemas {
    ...
    public static class ServerDll {
        ...
        public static class CBasePropDoor {
            ...
            public const nint m_hDoorList = 0xB98; // 
        ...
        public static class CPointValueRemapper {
            ...
            public const nint m_hOutputEntities = 0x518; // 
        ...
        public static class CPhysMagnet {
            ...
            public const nint m_MagnettedEntities = 0x948; // 
        ...
        public static class CBaseFlex {
            public const nint m_flexWeight = 0x8E8; // 
